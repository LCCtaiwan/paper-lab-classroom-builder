...
export default function Home() {
  return <main className="landing-shell">
    ...
    <section className="landing-principles"><p>Agent 草稿可選</p><p>教師決定節奏</p><p>學生不需帳號</p><p>問題不自動投影</p></section>
    <section className="landing-flow"><div><p className="eyebrow">ONE SOURCE OF TRUTH</p><h2>不論使用 Web、Codex 或 Claude Code，都回到同一份課程 Manifest。</h2></div><ol><li><span>01</span><b>提供 PDF</b><p>保留原頁序與 checksum。</p></li><li><span>02</span><b>確認脈絡</b><p>匯入 Agent 草稿或人工分段，再由教師設定停靠頁。</p></li><li><span>03</span><b>建立場次</b><p>講師、投影、學生三端同步。</p></li><li><span>04</span><b>回看困惑</b><p>每次場次保留獨立問題紀錄。</p></li></ol></section>
